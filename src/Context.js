...
export const initialState = {
    ...
    newDisaggregations:[
      {
        name: "HTS_TST",
        content: [ 
        'A new facility-based testing modality has been introduced: Post ANC1: Pregnancy/L&D/BF. Please refer to the HTS_TST indicator reference sheet for additional details.']
      },
      {
        name: "PP_PREV",
        content: [ 
        'A new, optional priority populations type disaggregate was added to this indicator to capture the specific priority populations accessing prevention services. Age/sex-specific priority populations were not added to this disaggregate group (e.g., AGYW) because these can be calculated using the mandatory age/sex disaggregates collected within the indicator.']
      },
      {
        name: "TX_TB",
        content: [ 
        'The denominator has been updated to include a new disaggregate for “positive result returned.”']
      }
    ],
    changeFrequencies:[
      {
        name: "PrEP_NEW",
        content: [ 
        'The reporting frequency moves from quarterly to semi-annually in FY19 to align the prevention indicators.']
      },
      {
        name: "TB_ART",
        content: [ 
        'The reporting frequency moves from semi-annually to quarterly in FY19 to align with the ART-related indicators and TB_STAT.']
      },
      {
        name: "TB_STAT",
        content: [ 
        'The reporting frequency moves from semi-annually to quarterly in FY19 to align with HTS_TST.']
      },
      {
        name: "TX_PVLS",
        content: [ 
        'The reporting frequency moves from annually to quarterly in FY19 to ensure that the treatment cascade can be reviewed quarterly and to emphasize the importance of regularly monitoring viral load coverage and suppression.']
      }
    ],
    modifyIndicators:[
      {
        name: "HRH_CURR",
        content: [ 
        'The reporting of HRH_CURR by the number of full-time equivalents is no longer required. HRH_CURR has been simplified to collect the total number of staff (regardless of FTE). In addition, a new data element has been added to capture the amount of funding spent on health care workers by cadre and support type.']
      },
      {
        name: "PMTCT_EID",
        content: [ 
        'The denominator has been updated to include HIV+ pregnant women identified after ANC1, including those women who test positives later in pregnancy, at labor and delivery, and throughout the breastfeeding period. The positive results for these women will be captured under the newly added HTS modality, Post ANC1: Pregnancy/L&D/BF and will be summed with the positives (new and known) from ANC1 (i.e., PMTCT_STAT_POS) to obtain the total denominator.']
      }
    ],
    modifyDisaggregations:[
      {
        name: "OVC_HIVSTAT",
        content: [ 
        'The status type disaggregates have been modified. The sub-disaggregate under “No status reported” formerly called “Test not indicated” will now be “Test not required based on risk assessment” to simplify the language.']
      },
      {
        name: "OVC_SERV",
        content: [ 
        'Age/sex and program status (i.e., active or graduated) disaggregations have been combined.']
      },
      {
        name: "PMTCT_ART",
        content: [ 
        'Age disaggregations were added to the “maternal regimen type” disaggregate to align with PMTCT_STAT. Age disaggregations were not previously collected for PMTCT_ART.']
      },
      {
        name: "PREP_NEW",
        content: [ 
        'The KP type disaggregation for this indicator has been updated. “Other key population” has been removed and replaced with “people who inject drugs” and “people in prisons and other closed settings” so that all key population disaggregate group options align between HTS_TST, TX_NEW, PrEP_CURR, and PrEP_NEW .']
      },
      {
        name: "TB_ART",
        content: [ 
        'Age/sex and “ART status” disaggregations have been combined.']
      },
      {
        name: "TB_PREV",
        content: [ 
        'Age/sex and “Type of TB preventive therapy by ART Start” disaggregations have been combined for both the numerator and the denominator.']
      },
      {
        name: "TB_STAT",
        content: [ 
        'Age/sex disaggregations were updated from coarse-only to fine age bands to allow TB_STAT to auto-populate HTS_TST via the TB modality and to align with the age bands for TB_ART.']
      },
      {
        name: "TX_TB",
        content: [ 
        'Age/sex and “ART Status” disaggregations have been combined for the numerator. Age/sex and “Start of ART by Screen Results” disaggregations have been combined for the denominator.']
      },
      {
        name: "VMMC_CIRC",
        content: [ 
        'Age disaggregations were added to the “HIV Status and Outcome” disaggregate in order for VMMC HTS results to auto-populate into the HTS_TST indicator. Note that the age disaggregations align with HTS_TST to allow for auto-population. This means the <4 disaggregations differ slightly from the indicator itself.']
      }
    ],
    retiredIndicators:[
      {
        name: "TX_RET",
        content: [ 
        'Indicator has been removed in order to incorporate the new TX_ML indicator and strengthen reporting on TX_PVLS.']
      }
    ],
    retiredDisaggregations:[
      ...
      },
      {
        name: "PMTCT_STAT",
        content: [ 
        'The age-only disaggregate was removed to minimize duplicative reporting. Age is already captured under the status and age disaggregate group.']
      },
      {
        name: "TX_NEW",
        content: [ 
        'The “confirmed diagnosis of TB” disaggregate was removed as TB_ART results have moved to quarterly reporting.']
      }
    ],
  };